...
from .. import stafford_led_ns

AUTO_LOAD = ["output"]

StaffordLEDLightOutput = stafford_led_ns.class_(
    "StaffordLEDLightOutput", light.LightOutput, cg.Component
)

CONFIG_SCHEMA = cv.All(
    light.BINARY_LIGHT_SCHEMA.extend(
        {
            cv.GenerateID(CONF_OUTPUT_ID): cv.declare_id(StaffordLEDLightOutput),
